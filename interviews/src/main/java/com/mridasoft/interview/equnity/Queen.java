...
public class Queen implements Piece {
    ...
    static {
        ALLOWED_MOVES.put(0,asList(7,8,9,5,2));
        ALLOWED_MOVES.put(1,asList(0,2,3,4,5,7,9));
        ALLOWED_MOVES.put(2,asList(1,3,4,5,6,8,0));
        ALLOWED_MOVES.put(3,asList(1,2,5,7,6,9));
        ALLOWED_MOVES.put(4,asList(1,2,5,7,8,6));
    ...
    public static void main(String[] args) {
        ...
        long n =  Queen.calcLegalPhoneNumbers(0,10,"", numbers);
